    ...
    <footer className="footer">
      <div className="footer-content">
        ...
        <div className="footer-logo-section">
          <h2 className="footer-logo">Mendioraa Event Management</h2>
          <p>
            Planning a full event has never been easier! Mendioraa Event Management, an ISO 9001-2015 Certified Event
